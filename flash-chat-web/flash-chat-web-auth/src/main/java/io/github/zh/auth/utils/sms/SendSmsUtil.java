package io.github.zh.auth.utils.sms;
...
public class SendSmsUtil {
    ...
    public void sendSms(String sendPhone,String sendCode) {
        ...
        String sdkAppId = smsConfigProperties.getSmsSdkAppId();
        ...
        String templateId = smsConfigProperties.getTemplateId();
        req.setTemplateId(templateId);

        /* 模板参数: 模板参数的个数需要与 TemplateId 对应模板的变量个数保持一致，若无模板参数，则设置为空 */
        String[] templateParamSet = {sendCode};
        req.setTemplateParamSet(templateParamSet);

        /* 下发手机号码，采用 E.164 标准，+[国家或地区码][手机号]
         * 示例如：+8613711112222， 其中前面有一个+号 ，86为国家码，13711112222为手机号，最多不要超过200个手机号 */
        String[] phoneNumberSet = {sendPhone};
        ...
        /* 通过 client 对象调用 SendSmsUtil 方法发起请求。注意请求方法名与请求对象是对应的
